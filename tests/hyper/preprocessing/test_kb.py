...
class TestKnowledgeBaseParser(unittest.TestCase):
    ...
    def test_kb_parser_sorted(self):
        ...
        self.assertTrue(parser.entity_index['s3'] == 3)
        self.assertTrue(parser.entity_index['s4'] == 4)
        self.assertTrue(parser.entity_index['s5'] == 5)

        self.assertTrue(parser.predicate_index['p1'] == 1)
        self.assertTrue(parser.predicate_index['p2'] == 2)
        self.assertTrue(parser.predicate_index['p3'] == 3)
