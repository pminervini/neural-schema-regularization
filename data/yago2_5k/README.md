...
$ ../tools/splitter.py --kb yago2core_facts.clean.notypes.tsv --train yago2-train.txt --validation yago2-valid.txt --validation-size 5000 --test yago2-test.txt --test-size 5000 --seed 0
...
$ wc -l *.txt
5000 yago2-test.txt
938358 yago2-train.txt
5000 yago2-valid.txt
948358 total
$ mv *.txt ..
$ cd ..
$ gzip -9 yago2-*.txt
