...
$ ../tools/splitter.py --kb yagoFacts.tsv --train yago3-train.txt --validation yago3-valid.txt --validation-size 1000 --test yago3-test.txt --test-size 1000 --seed 0
...
$ wc -l *.txt
1000 yago3-test.txt
5626166 yago3-train.txt
1000 yago3-valid.txt
5628166 total
$ mv *.txt ..
$ cd ..
$ gzip -9 yago3-*.txt
