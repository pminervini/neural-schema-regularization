...
$ ../tools/splitter.py --kb yago2core_facts.clean.notypes.tsv
--train yago2-train.txt --validation yago2-valid.txt --validation-size 50000
--test yago2-test.txt --test-size 50000 --seed 0
...
DEBUG:root:Saving ..
$ wc -l *.txt
   50000 yago2-test.txt
  848358 yago2-train.txt
   50000 yago2-valid.txt
  948358 total
$ mv *.txt ..
$ cd ..
$ gzip -9 yago2-*.txt
